...
PROGMEM const mavlink::ParameterMgt::ParamInfo info[] = {
		...
		PARAM(REAL32,"ATT_FX_N0", (void*)&paramAttCtrl.filterTrqX.a0, K_ATTCTRL_FILT_TRQ_X_NUM_0),
		PARAM(REAL32,"ATT_FX_N1", (void*)&paramAttCtrl.filterTrqX.a1, K_ATTCTRL_FILT_TRQ_X_NUM_1),
		PARAM(REAL32,"ATT_FX_N2", (void*)&paramAttCtrl.filterTrqX.a2, K_ATTCTRL_FILT_TRQ_X_NUM_2),
		PARAM(REAL32,"ATT_FX_D1", (void*)&paramAttCtrl.filterTrqX.b1, -K_ATTCTRL_FILT_TRQ_X_DEN_1),
		PARAM(REAL32,"ATT_FX_D2", (void*)&paramAttCtrl.filterTrqX.b2, -K_ATTCTRL_FILT_TRQ_X_DEN_2),
		PARAM(REAL32,"ATT_FY_N0", (void*)&paramAttCtrl.filterTrqY.a0, K_ATTCTRL_FILT_TRQ_Y_NUM_0),
		PARAM(REAL32,"ATT_FY_N1", (void*)&paramAttCtrl.filterTrqY.a1, K_ATTCTRL_FILT_TRQ_Y_NUM_1),
		PARAM(REAL32,"ATT_FY_N2", (void*)&paramAttCtrl.filterTrqY.a2, K_ATTCTRL_FILT_TRQ_Y_NUM_2),
		PARAM(REAL32,"ATT_FY_D1", (void*)&paramAttCtrl.filterTrqY.b1, -K_ATTCTRL_FILT_TRQ_Y_DEN_1),
		PARAM(REAL32,"ATT_FY_D2", (void*)&paramAttCtrl.filterTrqY.b2, -K_ATTCTRL_FILT_TRQ_Y_DEN_2),
		PARAM(REAL32,"ATT_FZ_N0", (void*)&paramAttCtrl.filterTrqZ.a0, K_ATTCTRL_FILT_TRQ_Z_NUM_0),
		PARAM(REAL32,"ATT_FZ_N1", (void*)&paramAttCtrl.filterTrqZ.a1, K_ATTCTRL_FILT_TRQ_Z_NUM_1),
		PARAM(REAL32,"ATT_FZ_N2", (void*)&paramAttCtrl.filterTrqZ.a2, K_ATTCTRL_FILT_TRQ_Z_NUM_2),
		PARAM(REAL32,"ATT_FZ_D1", (void*)&paramAttCtrl.filterTrqZ.b1, -K_ATTCTRL_FILT_TRQ_Z_DEN_1),
		PARAM(REAL32,"ATT_FZ_D2", (void*)&paramAttCtrl.filterTrqZ.b2, -K_ATTCTRL_FILT_TRQ_Z_DEN_2),
